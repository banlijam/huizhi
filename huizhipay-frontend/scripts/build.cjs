...
function writeRouteEntrypoints() {
  const routes = {
    ...
    'merchant/orders': 'index.html',
    'merchant/onboarding': 'index.html',
    'merchant/ledger': 'index.html',
    'merchant/risk': 'index.html',
    'merchant/wallet': 'index.html',
    'merchant/developer': 'index.html',
    'merchant/developer/api-keys': 'index.html',
    'merchant/developer/sandbox': 'index.html',
    'merchant/developer/webhooks': 'index.html',
    'merchant/developer/logs': 'index.html',
    'developer/api-keys': 'index.html',
    'developer/sandbox': 'index.html',
    'developer/webhooks': 'index.html',
    'developer/logs': 'index.html',
